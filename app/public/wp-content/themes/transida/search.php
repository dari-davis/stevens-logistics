...
get_header();
global $wp_query;
$data  = \TRANSIDA\Includes\Classes\Common::instance()->data( 'search' )->get();
            ...
            <div class="row clearfix">
                ...
                <div class="content-side <?php echo esc_attr( $class ); ?>">
                    ...
                    <div class="pagination text-center clearfix">
                        <?php transida_the_pagination( $wp_query->max_num_pages );?>
                    </div>
                        
					<?php else : ?>
                    <div class="search-notfound">
                        <p><?php esc_html_e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'transida' ); ?></p>
