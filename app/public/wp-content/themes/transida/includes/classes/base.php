...
use TRANSIDA\Includes\Classes\Header_Enqueue;
use TRANSIDA\Includes\Classes\Options;
...
class Base {
	 ...
	 * @var string
	 */
	private $option_key = TRANSIDA_NAME;
	...
	public static function instance() {
		...
		if ( isset( $GLOBALS['transida_base'] ) ) {
			return $GLOBALS['transida_base'];
		}
	...
	function option( $key = '' ) {
		...
		$options = (array) get_theme_mod( TRANSIDA_NAME . '_options-mods' );

		$dn = transida_dot( $options );
