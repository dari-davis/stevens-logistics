 ...
 * @author   Wptech
 */
class History extends Post_Type {

	protected $post_type = 'transida_history';
	...
	public static function init() {
		...
		self::instance()->menu_name = esc_html__( 'Our History', 'wpfixker' );
		self::instance()->singular  = esc_html__( 'History', 'wptransida' );
		self::instance()->plural    = esc_html__( 'History', 'wptransida' );
