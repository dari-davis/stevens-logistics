 ...
 * @since 1.0.0
 */
class Request_A_Quote extends Widget_Base {
	...
	public function get_name() {
		return 'transida_request_a_quote';
	}
	...
	public function get_title() {
		return esc_html__( 'Request A Quote', 'transida' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'request_a_quote',
			[
				'label' => esc_html__( 'Request A Quote', 'transida' ),
			]
		);
		$this->add_control(
			'subtitle',
	...
	protected function render() {
        ...
        <section class="getaquote-section style-four">
            <div class="auto-container">
                ...
                <?php echo do_shortcode($settings['contact_form_url3'], true);?>
            </div>
        </section>
