...
class Recent_Projects extends Widget_Base {
	...
	public function get_name() {
		return 'transida_recent_projects';
	}
	...
	public function get_title() {
		return esc_html__( 'Recent Projects', 'transida' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'recent_projects',
			[
				'label' => esc_html__( 'Recent Projects', 'transida' ),
			]
		);
		$this->add_control(
			'subtitle',
            ...
            <div class="auto-container">
                <div class="title-box">
                    <div class="row m-0 align-items-center justify-content-between">
                        ...
                        <div class="link"><a href="<?php echo esc_url($settings['btn_link']['url']);?>" class="readmore-link"><i class="flaticon-up-arrow"></i><?php echo wp_kses($settings['btn_title'], true);?></a></div>
                    </div>
                </div>
                <div class="row">
                    <?php 
                    ...
                    <div class="col-xl-3 col-lg-6 project-block">
                        <div class="inner-box wow fadeInUp" data-wow-duration="1500ms">
                            ...
                            <div class="image">
                                <?php the_post_thumbnail('transida_442x410'); ?>
                            ...
                            <div class="lower-content">
                                ...
                                <h4><?php the_title(); ?></h4>
                                <div class="link-btn"><a href="<?php echo esc_url(get_post_meta( get_the_id(), 'project_link', true ));?>"><span class="flaticon-up-arrow"></span></a></div>
                            </div>
                        </div>
                    </div>
                	<?php endwhile; ?>
