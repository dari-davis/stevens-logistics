...
class Slider_V2 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Slider V2', 'transida' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'slider_v2',
			[
				'label' => esc_html__( 'Slider V2', 'transida' ),
			]
		);
		$this->add_control(
              'slide', 
			  	[
            		...
            		'default' => 
						[
                			['title' => esc_html__('Delivering ', 'transida')],
                			['title' => esc_html__('New track', 'transida')],
							['title' => esc_html__('Quality is', 'transida')],
            			],
            		'fields' => 
						[
                			[
                    ...
                    <div class="swiper-slide" <?php if($item['slide_image']['id']): ?>style="background-image: url(<?php echo esc_url(wp_get_attachment_url($item['slide_image']['id']));?>);"<?php endif; ?>>
                        <div class="content-outer">
                            <div class="content-box">
                                <div class="inner">
                                    <?php if($item['badge_image']['id']): ?><div class="logo"><img src="<?php echo esc_url(wp_get_attachment_url($item['badge_image']['id']));?>" alt="<?php esc_attr_e('Awesome Image', 'transida'); ?>"></div><?php endif; ?>
                                    <h1><?php echo wp_kses( $item['title'], true );?></h1>
                                    <div class="text"><i class="far fa-meh"></i><?php echo wp_kses( $item['text'], true );?></div>
                                    <div class="link-box">
