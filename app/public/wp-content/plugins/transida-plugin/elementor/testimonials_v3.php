...
class Testimonials_V3 extends Widget_Base {
	...
	public function get_name() {
		return 'transida_testimonials_v3';
	}
	...
	public function get_title() {
		return esc_html__( 'Testimonials V3', 'transida' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'testimonials_v3',
			[
				'label' => esc_html__( 'Testimonials V3', 'transida' ),
			]
		);
		$this->add_control(
			'bg_img',
				[
				  'label' => __( 'Background Icon Image', 'transida' ),
		...
		$this->add_control(
			'happy_client',
			[
				'label'       => __( 'Happy Clients', 'transida' ),
				'type'        => Controls_Manager::TEXT,
				'label_block' => true,
				'dynamic'     => [
					'active' => true,
				],
				'placeholder' => __( 'Enter your Happy Clients Value', 'transida' ),
			]
		);
		$this->add_control(
			'client_description',
			[
				'label'       => __( 'Client Description', 'transida' ),
				'type'        => Controls_Manager::TEXTAREA,
				'label_block' => true,
				'dynamic'     => [
					'active' => true,
				],
				'placeholder' => __( 'Enter your Client Description', 'transida' ),
			]
		);
		$this->add_control(
			'text_limit',
	...
	protected function render() {
		...
		if( transida_set( $settings, 'query_category' ) ) $args['testimonials_cat'] = transida_set( $settings, 'query_category' );
        ...
        <section class="testimonials-section-three mx-30">
            <?php if($settings['bg_img']['id']): ?><div class="background-icon"><img src="<?php echo esc_url(wp_get_attachment_url($settings['bg_img']['id']));?>" alt="<?php esc_attr_e('Awesome Image', 'transida'); ?>"></div><?php endif; ?>
            <div class="auto-container">
                <div class="row">
                    <div class="col-xl-6">
                        <div class="video-box">
                            <?php if($settings['video_img']['id']): ?><div class="image"><img src="<?php echo esc_url(wp_get_attachment_url($settings['video_img']['id']));?>" alt="<?php esc_attr_e('Awesome Image', 'transida'); ?>"></div><?php endif; ?>
                            <div class="video-btn">
                                <a href="<?php echo esc_url($settings['video_link']['url']);?>" class="overlay-link lightbox-image video-fancybox"><span class="flaticon-play-arrow"></span></a>
                            </div>
                            <div class="content">
                                <div>
                                    <h2><?php echo wp_kses( $settings['happy_client'], true );?> </h2>
                                    <div class="text"><?php echo wp_kses( $settings['client_description'], true );?></div>
                                </div>                        
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="inner-container">
                            <div class="testimonial-block-area">
                                <div class="swiper-container testimonial-thumbs">
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="author-thumb"><?php the_post_thumbnail('transida_110x110'); ?></div>
                                        </div>
                                        <?php endif; ?>
                                        <?php endwhile; ?> 
                                    </div>
                                                ...
                                                <div class="inner-box">
                                                    <div class="inner-box">
                                                        ...
                                                        <div class="author-thumb">
                                                            <?php the_post_thumbnail('transida_110x110'); ?>
                                ...
                                <div class="testimonial-slider-nav">
                                    <div class="testimonial-slider-control testimonial-slider-button-prev"><span><i class="flaticon-right-arrow-6"></i></span></div>
                                    <div class="testimonial-slider-control testimonial-slider-button-next"><span><i class="flaticon-right-arrow-6"></i></span> </div>
                                </div>                       
                            </div>
                        </div>
