...
class Portfolio_4_Column extends Widget_Base {
	...
	public function get_name() {
		return 'transida_portfolio_4_column';
	}
	...
	public function get_title() {
		return esc_html__( 'Portfolio 4 Column', 'transida' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'portfolio_4_column',
			[
				'label' => esc_html__( 'Portfolio 4 Column', 'transida' ),
			]
		);
		$this->add_control(
			'number',
	...
	protected function render() {
		...
		<?php 
            ...
            <!-- Project Block -->
            <div class="col-xl-3 col-lg-6 project-block masonry-item all <?php echo esc_attr($term_slug); ?>">
                <div class="inner-box">
