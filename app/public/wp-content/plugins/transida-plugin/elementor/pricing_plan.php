...
class Pricing_Plan extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Pricing Plan', 'transida' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'pricing_plan',
			[
				'label' => esc_html__( 'Pricing Plan', 'transida' ),
			]
		);
		$this->add_control(
			'subtitle',
			  	...
			  	[
            		...
            		'fields' => 
						[
							...
							[
                    			'name' => 'duration',
                    			'label' => esc_html__('Duration', 'transida'),
								'label_block' => true,
                    			'type' => Controls_Manager::TEXT,
								'default' => esc_html__('', 'transida')
                			],
        ...
        <section class="pricing-section">
            <div class="auto-container">
                ...
                <div class="row m-0">
                    ...
                    <div class="col-lg-4 col-md-6 pricing-block <?php if($item['style_two'] == 'two') echo 'style-two'; else echo '' ; ?>">
                        <div class="inner-box wow fadeInUp" data-wow-duration="1500ms" <?php if($item['style_two'] == 'two'): ?>style="background-image: url(<?php echo esc_url(wp_get_attachment_url($item['bg_img']['id']));?>);"<?php endif; ?>>
                            ...
                            <div class="time"><?php echo wp_kses($item['duration'], true);?></div>
