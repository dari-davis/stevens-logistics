...
class Latest_News_V3 extends Widget_Base {
    ...
    public function get_name() {
        return 'transida_latest_news_v3';
    }
    ...
    public function get_title() {
        return esc_html__( 'Latest News V3', 'transida' );
    }
    ...
    protected function _register_controls() {
		$this->start_controls_section(
			'latest_news_v3',
			[
				'label' => esc_html__( 'Latest News V3', 'transida' ),
			]
		);
		$this->add_control(
			'subtitle',
            ...
            <div class="auto-container">
                ...
                <div class="row">
                    <div class="theme_carousel owl-theme owl-carousel" data-options='{"loop": true, "center": false, "margin": 0, "autoheight":true, "lazyload":true, "nav": true, "dots": true, "autoplay": true, "autoplayTimeout": 6000, "smartSpeed": 1000, "responsive":{ "0" :{ "items": "1" }, "600" :{ "items" : "1" }, "768" :{ "items" : "2" } , "992":{ "items" : "3" }, "1200":{ "items" : "3" }}}'>
						...
						?>
                        <div class="news-block-three col-lg-12">
                            <div class="inner-box">
                                <div class="image">
                                ...
                                <div class="lower-content">
                                    ...
                                    <div class="link">
                                        <a href="<?php echo esc_url( the_permalink( get_the_id() ) );?>" class="readmore-link"><span><i class="flaticon-up-arrow"></i><?php esc_html_e('More Details', 'transida'); ?></span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
