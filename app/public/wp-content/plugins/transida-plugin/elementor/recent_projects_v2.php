...
class Recent_Projects_V2 extends Widget_Base {
	...
	public function get_name() {
		return 'transida_recent_projects_v2';
	}
	...
	public function get_title() {
		return esc_html__( 'Recent Projects V2', 'transida' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'recent_projects_v2',
			[
				'label' => esc_html__( 'Recent Projects V2', 'transida' ),
			]
		);
		$this->add_control(
			'subtitle',
        ...
        <section class="projects-section-two">
            <div class="auto-container">
                ...
                <div class="row">
					...
					?>
                    <div class="col-lg-4 col-md-6 project-block-two">
                        <div class="inner-box wow fadeInUp" data-wow-duration="1500ms">
                            <?php if(has_post_thumbnail()): ?>
                            <div class="image">
                                <?php the_post_thumbnail('transida_370x400'); ?>
                            ...
                            <div class="lower-content">
                                ...
                                <h4><?php the_title(); ?></h4>
                                <div class="link-btn"><a href="<?php echo esc_url(get_post_meta( get_the_id(), 'project_link', true ));?>"><span class="flaticon-right-arrow-6"></span></a></div>
                            </div>
                        </div>
                    </div>
                    <?php endwhile; ?>
