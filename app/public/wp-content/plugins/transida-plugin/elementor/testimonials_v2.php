...
class Testimonials_V2 extends Widget_Base {
	...
	public function get_name() {
		return 'transida_testimonials_v2';
	}
	...
	public function get_title() {
		return esc_html__( 'Testimonials V2', 'transida' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'testimonials_v2',
			[
				'label' => esc_html__( 'Testimonials V2', 'transida' ),
			]
		);
		$this->add_control(
			'bg_img',
	...
	protected function render() {
        ...
        <section class="testimonials-section-two" <?php if($settings['bg_img']['id']): ?>style="background-image: url(<?php echo esc_url(wp_get_attachment_url($settings['bg_img']['id']));?>);"<?php endif; ?>>
                        ...
                        <div class="testimonial-block-two">
                            <div class="inner-box">
                                ...
                                <div class="author-thumb">
                                    <?php the_post_thumbnail('transida_100x100'); ?>
