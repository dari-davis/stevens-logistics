 ...
 * @since 1.0.0
 */
class Blog_Width_Sidebar extends Widget_Base {
	...
	public function get_name() {
		return 'transida_blog_width_sidebar';
	}
	...
	public function get_title() {
		return esc_html__( 'Blog Width Sidebar', 'transida' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'blog_width_sidebar',
			[
				'label' => esc_html__( 'Blog Width Sidebar', 'transida' ),
			]
		);
		$this->add_control(
			'sidebar_slug',
                        ...
                        <div class="row">
                            ...
                            <div class="news-block-one style-two col-lg-4 col-md-6">
                                <div class="inner-box">
                                    ...
                                    <div class="image">
                                        <?php the_post_thumbnail('transida_270x270'); ?>
