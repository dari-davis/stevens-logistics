...
class Our_Services_V4 extends Widget_Base {
	...
	public function get_name() {
		return 'transida_our_services_v4';
	}
	...
	public function get_title() {
		return esc_html__( 'Our Services V4', 'transida' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'our_services_v4',
			[
				'label' => esc_html__( 'Our Services V4', 'transida' ),
			]
		);
		$this->add_control(
			'bg_img',
                            ...
                            <div class="inner-box">
                                <div class="image-box">
                                    ...
                                    <div class="content">
                                        ...
                                        <div>
                                            <div class="link">
                                                <a href="<?php echo esc_url(get_post_meta( get_the_id(), 'ext_url', true ));?>"><?php esc_html_e('About', 'transida'); ?></a>
                                                <a href="<?php echo esc_url(get_post_meta( get_the_id(), 'ext_url', true ));?>" class="hover-link"><i class="flaticon-right-arrow-3"></i><?php esc_html_e('Know About', 'transida'); ?></a>
                                            </div>                                       
                                            <h4><?php the_title(); ?></h4>
                                        </div>            
                                    </div>
