...
class Testimonials_V4 extends Widget_Base {
	...
	public function get_name() {
		return 'transida_testimonials_v4';
	}
	...
	public function get_title() {
		return esc_html__( 'Testimonials V4', 'transida' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'testimonials_v4',
			[
				'label' => esc_html__( 'Testimonials V4', 'transida' ),
			]
		);
		$this->add_control(
			'text_limit',
	...
	protected function render() {
        ...
        <section class="testimonials-section-four">
                            ...
                            <div class="testimonial-block-four">
                                <div class="inner-box">
                                    ...
                                    <div class="author-thumb">
                                        <?php the_post_thumbnail('transida_170x170'); ?>
