 ...
 * @since 1.0.0
 */
class Related_Projects extends Widget_Base {
	...
	public function get_name() {
		return 'transida_related_projects';
	}
	...
	public function get_title() {
		return esc_html__( 'Related Projects', 'transida' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'related_projects',
			[
				'label' => esc_html__( 'Related Projects', 'transida' ),
			]
		);
		$this->add_control(
			'title',
