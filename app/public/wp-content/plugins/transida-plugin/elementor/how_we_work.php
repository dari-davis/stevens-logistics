 ...
 * @since 1.0.0
 */
class How_We_Work extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'How We Work', 'transida' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'how_we_work',
			[
				'label' => esc_html__( 'How We Work', 'transida' ),
			]
		);
		$this->add_control(
			'bg_img',
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => __( 'Enter your Section Bottom Description', 'transida' ),
			]
		);
	...
	protected function render() {
        ...
        <section class="work-process-section" id="works">
            <div class="bg" <?php if($settings['bg_img']['id']): ?>style="background-image: url(<?php echo esc_url(wp_get_attachment_url($settings['bg_img']['id']));?>);"<?php endif; ?>></div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 work-process-block">
                        <div class="inner-box wow fadeInUp" data-wow-duration="1500ms">
                            ...
                            <a href="<?php echo esc_url(get_post_meta( get_the_id(), 'ext_url', true ));?>" class="readmore-link"><i class="flaticon-up-arrow"></i><?php esc_html_e('More Details', 'transida'); ?></a>
                        </div>
                    </div>
                    <?php $count++; endwhile; ?>
                </div>
                <div class="bottom-text"><?php echo wp_kses($settings['text'], true);?></div>
            </div>
        </section>
