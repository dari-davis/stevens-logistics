 ...
 * @since 1.0.0
 */
class Portfolio_3_Column extends Widget_Base {
	...
	public function get_name() {
		return 'transida_portfolio_3_column';
	}
	...
	public function get_title() {
		return esc_html__( 'Portfolio 3 Column', 'transida' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'portfolio_3_column',
			[
				'label' => esc_html__( 'Portfolio 3 Column', 'transida' ),
			]
		);
		$this->add_control(
			'number',
	...
	protected function render() {
		...
		<?php 
            ...
            <!-- Project Block -->
            <div class="col-lg-4 col-md-6 project-block-two masonry-item all <?php echo esc_attr($term_slug); ?>">
                <div class="inner-box">
