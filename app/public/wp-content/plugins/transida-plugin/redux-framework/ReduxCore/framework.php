                ...
                if ( ! empty ( $field['required'] ) ) {
                    if ( isset ( $field['required'][0] ) ) {
                        if ( ! is_array( $field['required'][0] ) && count( $field['required'] ) == 3 ) {
                            $parentValue = transida_set( $GLOBALS[ $this->args['global_variable'] ], $field['required'][0] );
                            ...
                            foreach ( $field['required'] as $required ) {
                                if ( ! is_array( $required[0] ) && count( $required ) == 3 ) {
                                    $parentValue = transida_set(transida_set($GLOBALS, transida_set($this->args, 'global_variable' ) ), transida_set($required,'0') );
